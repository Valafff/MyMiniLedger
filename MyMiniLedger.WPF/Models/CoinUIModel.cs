...
namespace MyMiniLedger.WPF.Models
{
	...
	public class CoinUIModel: BaseNotify, ICloneable, IComparable<CoinUIModel>
    {
		private int _id;
		public int Id 
		{ 
		...
		public int CompareTo(CoinUIModel? other)
		{
			return string.Compare(this.ShortName, other.ShortName);
		}
	}
}
